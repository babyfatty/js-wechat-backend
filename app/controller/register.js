...
register.getInfo = function* (next){
  ...
  if(check){
    this.redirect('https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxab5e05ece55fcade&redirect_uri=http%3A%2F%2Faosaikangjs.xiaonian.me%2Frevise&response_type=code&scope=snsapi_base&state=123#wechat_redirect');    
    return
  }
