...
$('#submitBtn').on('click',function(){
	...
	$.post('http://aosaikang.xiaonian.me/api/student/update', { 
	 ...
	 "s.parent_phone": param[10].value
  		...
  		window.location.replace("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0b4f6ee3da84307c&redirect_uri=http%3A%2F%2Faosaikangjs.xiaonian.me%2F&response_type=code&scope=snsapi_base&state=123#wechat_redirect")
	})
})